  ...
  return (
    <Link
      ...
      className="w-full border border-black border-opacity-20 rounded shadow-sm overflow-hidden
       ...
       "
    >
      <div className="w-full sm:h-[160px] h-[120px] ">
        <img
      ...
      <div className="w-full sm:space-y-2 space-y-1 sm:p-3 p-2">
        <Heading tag="h6" className="line-clamp-2 sm:!text-base !text-sm">
          Grade 10 Bio ( Chapter 10 )
        </Heading>
        <p className="sm:text-xs text-[10px] font-[300] text-gray-500 line-clamp-3">
