    ...
    <div className="mt-6 space-y-4 px-2">
      ...
      <div className="sm:flex grid grid-cols-2 items-center sm:gap-4 gap-2">
        <div className="flex items-center gap-1">
          <IoMdTime size={18} />
          <p className="text-xs sm:text-sm text-gray-800">01 Dec 2000</p>
        </div>

        <div className="flex items-center gap-1">
          <MdOutlineSchool size={18} />
          <p className="text-xs sm:text-sm text-gray-800">Grade - 10</p>
        </div>

        <div className="flex items-center gap-1">
          <MdOutlineMeetingRoom size={18} />
          <p className="text-xs sm:text-sm text-gray-800">Section - A</p>
        </div>

        <div className="flex items-center gap-1">
          <LuUsers size={18} />
          <p className="text-xs sm:text-sm text-gray-800">1,001</p>
        </div>
      </div>
    </div>
  );
